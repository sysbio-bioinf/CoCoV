...
module.exports = env => {
    ...
    const config = {
        ...
        { from: '**/*.html', noErrorOnMissing: true, globOptions: { dot: false, ...copyIgnore } },
		{ from: '**/*.json', noErrorOnMissing: true, globOptions: { dot: false, ...copyIgnore } },
        { from: '**/*.svg', noErrorOnMissing: true, globOptions: { dot: false, ...copyIgnore } },
        { from: 'assets/*.cer', noErrorOnMissing: true, globOptions: { dot: false, ...copyIgnore } },
              ],
            }),
