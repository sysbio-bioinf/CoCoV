...
<GridLayout id="diarrhea" row="0" rows="auto, *, *, *, *, *, *">
    <Label id="questionLabel" row="0" text="{{ diarrheaQuery }}" fontSize="{{ mySize }}" textWrap="true" class="questionText text-center" />
    ...
    <Button row="6" id="4" text="{{ diarrheaAnswer4 }}" textWrap="true" fontSize="{{ mySizeSmall }}" class="-btn my-button-grad4 my-button-grad4:active capitalization" tap="{{ switchTab }}" />
</GridLayout>
`;
