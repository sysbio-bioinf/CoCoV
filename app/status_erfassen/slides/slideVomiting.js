...
<GridLayout id="vomiting" row="0" rows="auto, *, *, *, *, *, *">
    <Label  id="questionLabel" row="0" text="{{ vomitingQuery }}" fontSize="{{ mySize }}" textWrap="true" class="questionText text-center" />
    <Button row="2" id="0" text="{{ vomitingAnswer0 }}" textWrap="true" fontSize="{{ mySizeSmall }}" class="-btn my-button-grad0 my-button-grad0:active capitalization" tap="{{ switchTab }}" />
